...
import dev.mydogsed.mydogsrpg.MyDogsRPG;
...
public class RegistrySlashCommandListener extends ListenerAdapter {
    ...
    */
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        if (!MyDogsRPG.commandRegistry.containsExecutor(command)){
        ...
        // Execute the command.
        MyDogsRPG.commandRegistry.getExecutor(command).onCommand(event);
    }
}
